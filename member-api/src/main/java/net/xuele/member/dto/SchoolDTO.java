...
public class SchoolDTO implements Serializable {
    private static final long serialVersionUID = 6228785433036800846L;
     ...
     * 自定义网站
     */
    private String customWeb;

    public String getCustomWeb() {
        return customWeb;
    }

    public void setCustomWeb(String customWeb) {
        this.customWeb = customWeb;
    }
